...
Contributions are welcome. Please open an issue or a pull request on the [GitHub repository](https://github.com/nowo-tech/RelativeTimeBundle) (Composer package: `nowo-tech/relative-time-bundle`).
