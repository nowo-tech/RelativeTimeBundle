# Relative Time Bundle - Symfony 7 Demo

Demo application for [`nowo-tech/relative-time-bundle`](https://packagist.org/packages/nowo-tech/relative-time-bundle) ([GitHub](https://github.com/nowo-tech/RelativeTimeBundle)) on Symfony 7.4.
...
The bundle is loaded from `/var/relative-time-bundle` (mounted from repo root). Run from the bundle repository.
